...
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithBaseURL], which most
...
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithTimeout], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
// Parameters:
...
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithUserAgent], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
...
//   - [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/retry] — option catalog.
...
//   - [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/observability] — option catalog.
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithObservabilityProvider],
...
//   - [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/observability.Provider]
//   - examples/10-observability-otel — runnable demo.
...
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithEnvironment], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
...
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithHTTPClient], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithLedgerURL], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithTracerURL], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
// This overrides any URL derived from the Environment setting.
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithTracerAPIKey],
...
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithDebug], which most
// callers should not invoke directly. Prefer this option when constructing the
// client via [New].
//
...
// request unless [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/sdkctx.WithIdempotencyKey] was used to set an explicit
// key on the per-request context.
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithIdempotency],
// which most callers should not invoke directly. Prefer this option when
// constructing the client via [New].
//
...
//
// See also:
//   - [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/sdkctx.WithIdempotencyKey] — caller-supplied key for one request.
//   - [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/sdkctx.WithoutAutoIdempotency] — per-call suppression.
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithAccessManager],
// which most callers should not invoke directly. Prefer this option when
// constructing the client via [New].
//
// Example:
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithAnonymous],
// which most callers should not invoke directly. Prefer this option when
// constructing the client via [New].
//
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithAllowInsecureAccessManagerHTTP],
// which most callers should not invoke directly.
//
...
// via [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.FromEnvironment]).
//
// Parameters:
...
//
// Two-layer surface: this is the user-facing wrapper. It delegates to
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithAllowInsecureHTTP],
// which most callers should not invoke directly.
//
...
// [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.FromEnvironment]).
//
