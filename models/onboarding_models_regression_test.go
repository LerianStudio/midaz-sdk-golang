...
func TestOnboardingModelsUpdateInputs_OmitUnsetPatchFields(t *testing.T) {
	tests := []struct {
		name  string
		input any
		want  string
...
func TestOnboardingModelsNilSafety(t *testing.T) {
	var (
...
func TestOnboardingModelsAssetAndPortfolioContracts(t *testing.T) {
