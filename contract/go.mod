...
module github.com/LerianStudio/midaz-sdk-golang/v5/contract

go 1.26.3

require (
	github.com/LerianStudio/midaz-sdk-golang/v5 v5.0.0
...
replace github.com/LerianStudio/midaz-sdk-golang/v5 => ../
