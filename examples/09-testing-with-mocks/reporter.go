...
// pass c.V1.Accounts (the facade satisfies your interface structurally);
...
// needs. c.V1.Accounts satisfies it in production; a local stub satisfies it
...
// in production, c.V1.Accounts; in tests, a local mock.
