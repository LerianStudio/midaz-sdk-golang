// Package adapters provides implementations of validation interfaces.
package adapters
...
// Ensure LibCommonsValidator implements ValidatorProvider
var _ core.ValidatorProvider = (*LibCommonsValidator)(nil)
