...
func TestErrorRedactionEnvelopeRedaction_RedactsPIIAndFinancialFields(t *testing.T) {
...
func TestErrorRedactionEnvelopeConstructors_WithTypedNilError_DoNotPanic(t *testing.T) {
...
func TestErrorRedactionEnvelopeGetErrorDetails_ExposesStructuredAPIEnvelope(t *testing.T) {
	err := &sdkerrors.Error{
