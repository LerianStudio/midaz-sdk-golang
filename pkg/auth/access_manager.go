...
//
// Construct one and pass it via [github.com/LerianStudio/midaz-sdk-golang/v6.WithAccessManager]
// (or [github.com/LerianStudio/midaz-sdk-golang/v6/pkg/config.WithAccessManager]
// when building a *config.Config directly). The midaz package re-exports this
// type as [github.com/LerianStudio/midaz-sdk-golang/v6.AccessManager] so a
