...
| 4 | Plano Tracer completo: rules (CEL), limits, reservations, validations, audit-events | 4.1, 4.2, 4.3 | **4.1 ✅ Done**; 4.2 Detailed (onda corrente); 4.3 Epic-level |
...
**Target:** midaz-sdk-golang
**Status:** Detailed (elaborado 2026-07-01 vs recon SDK+server `adc491fa`, 3 premissas corrigidas + verificadas por mim contra `tracer.gen.go`: reservations sem get/list, envelope-key `transactionValidations`, auth-wrinkle non-issue)
