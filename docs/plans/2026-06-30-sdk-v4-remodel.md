...
| 4 | Plano Tracer completo: rules (CEL), limits, reservations, validations, audit-events | 4.1, 4.2, 4.3 | Detailed (4.1 Detailed = onda corrente; 4.2, 4.3 Epic-level) |
...
**Target:** midaz-sdk-golang
**Status:** Detailed (elaborado 2026-07-01 vs recon SDK+server `a062c469`, alegações load-bearing re-derivadas por mim: helper-reuse, envelope de lista, money=decimal, 201)
