...
func TestSlice4OnboardingEntities_UseContractMethodsPathsAndBodies(t *testing.T) {
...
func TestSlice4AccountBalanceHelpers_UseTransactionURLAndLimitTwo(t *testing.T) {
	var nilContext context.Context
...
func TestSlice4UnsafeRetriesRequireCallerIdempotencyKey(t *testing.T) {
