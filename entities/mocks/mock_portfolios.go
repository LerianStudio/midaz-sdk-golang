...
func (mr *MockPortfoliosServiceMockRecorder) ListSegments(ctx, organizationID, ledgerID, portfolioID, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPortfoliosServiceMockRecorder) GetSegment(ctx, organizationID, ledgerID, portfolioID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPortfoliosServiceMockRecorder) CreateSegment(ctx, organizationID, ledgerID, portfolioID, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPortfoliosServiceMockRecorder) UpdateSegment(ctx, organizationID, ledgerID, portfolioID, id, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
